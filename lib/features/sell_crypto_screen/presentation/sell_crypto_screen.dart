...
class SellCryptoCoin extends StatefulWidget {
  const SellCryptoCoin({super.key});

  @override
  State<SellCryptoCoin> createState() => _SellCryptoCoinState();
}

class _SellCryptoCoinState extends State<SellCryptoCoin> {
